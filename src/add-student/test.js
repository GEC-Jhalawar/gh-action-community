...
const { data: { sha, content } } = await Octokit.request('GET /repos/GEC-Jhalawar/Support/contents/utils/StudentList.json', {
      owner: "GEC-Jhalawar",
      repo: "Support",
      file_path: "utils/StudentList.json"
    });
    console.log(sha, content);
